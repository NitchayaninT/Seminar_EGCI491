...
\begin{document}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{|p{2.15cm}|c|c|c|c|c|c|c|c|c|c|c|c|}
			...
			\multicolumn{1}{|c|}{\multirow{-3}{2cm}{\textbf{Plan}}} & \textbf{Jan} & \textbf{Feb} & \textbf{Mar} & \textbf{Aprl} & \textbf{May} & \textbf{Jun} & \textbf{Jul} & \textbf{Aug} & \textbf{Sep} & \textbf{Oct} & \textbf{Nov} & \textbf{Dec} \\ \hline
			1: Study PQA & 
